...
const TASK_TYPES = ["Routine", "Inspection", "Blockage", "Overflow", "Waste", "SOS Follow-up", "Citizen Report"];
...
const taskSchema = new mongoose.Schema({
  ...
  grievanceId: { type: String, default: null }, // linked citizen grievance (complaint)
